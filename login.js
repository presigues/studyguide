...
const submit = document.getElementById('login.html/login-comfirm');
submit.addEventListener("click", function (e) {
    e.preventDefault();

    const email = document.getElementById('login.html/login-email').value;
    const password = document.getElementById('login.html/login-pass').value;
